# Methods 3 & 4 interactive diagrams

Interactive diagrams that go with the Mathematical Methods 3 & 4 Bound Reference by Harry Nguyen.
...
Plain static HTML, no build step. KaTeX is loaded from jsDelivr.
